...
from Fermat_Primality_Test import Fermat_Primality_Test_Algorithm
from typing import Dict, List
from utils import find_number_of_bits
import time

number_of_bits_by_number = [40, 56, 80, 128, 168, 224, 256, 512]
...
with open("./Prime_numbers.txt", "w") as writer:
    ...
    for number_of_bits in number_of_bits_by_number:
        ...
        for _ in range(quantity_of_numbers):
            ...
            while not Fermat_Primality_Test_Algorithm(generated_number):    # Checks if its prime, if not, keeps generating numbers
